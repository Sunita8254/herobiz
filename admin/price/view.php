          ...
          <div class="card-body">
            ...
            <form class="row g-3" method="POST" action="" enctype="multipart/form-data">
              <div class="col-6">
                ...
                <input type="text" name="title" readonly class="form-control" value="<?php echo $data['title']; ?>" id="title">
              </div>
              <div class="col-6">
                <label for="price" class="form-label">price</label>
                <input type="text" name="price" readonly class="form-control" value="<?php echo $data['price']; ?>" id="price">
              </div>
